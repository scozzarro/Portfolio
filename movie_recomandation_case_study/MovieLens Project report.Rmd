...
We use the MovieLens 10M dataset that consists of 10M observed ratings from almost 70K different users applied to 10K different movies. We already divided the data set in 2 part with a proportion of 90/10 for train_set and test_set respectively.
...
To perform a preliminary analysis of the dataset we use the following packages:
